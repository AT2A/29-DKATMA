...
# ============================================
# ERCOT PRICE SIMULATION (single run)
# ============================================
def run_ercot_price_sim(
    cleaned_dir: str | Path = "data/cleaned",
    seed: int | None = None,
    save: bool = False,
    output_dir: str | Path = "data/simulations"
) -> pd.DataFrame:
    """Run a single Monte Carlo simulation projecting ERCOT Busbar prices."""
    rng = np.random.default_rng(seed)

    cleaned_dir = Path(cleaned_dir)
    cleaned_price_path = cleaned_dir / "ERCOT_cleaned.csv"
    forwards_path      = cleaned_dir / "ERCOT_forwards.csv"
...
# ============================================
# ERCOT GENERATION SIMULATION (optimized)
# ============================================
def run_ercot_gen_sim(
    ...
    """Run a synthetic ERCOT generation simulation using month-aware block bootstrapping."""
    rng = np.random.default_rng(seed)
    ...
    if hist_series is None:
        ...
        print(f"[ERCOT_gen ] reading: {input_csv}")
